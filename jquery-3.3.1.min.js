 ...
 * https://modernizr.com/download/?-cssanimations-cssgrid_cssgridlegacy-csstransforms-objectfit-touchevents-mq-setclasses !*/
!(function (e, n, t) {
  function r(e, n) {
    return typeof e === n;
  }
  ...
  function g(e, n, o, i) {
    ...
    for (
      ...
      (c = !0), (k.modElem = s(h.shift())), (k.style = k.modElem.style);
    for (p = e.length, d = 0; p > d; d++)
      if (
        ...
        if (k.style[m] != g) return a(), "pfx" == n ? m : !0;
      }
    return a(), !1;
  }
  ...
  var j = "Moz O ms Webkit",
    P = x._config.usePrefixes ? j.split(" ") : [];
  x._cssomPrefixes = P;
  var E = function (n) {
    var r,
      o = b.length,
...
ga.q = [];
ga.l = +new Date();
ga("create", addedlovely_ga.ga_tracking_code, "auto");
ga("send", "pageview");
var _extends =
    Object.assign ||
    function (e) {
...
!(function (e, t) {
  ...
  var e = {
    ...
    a = function (e, t, n) {
      return (
        (t === window ? window.pageXOffset : s(t)) >= s(e) + n + e.offsetWidth
      );
    },
    c = function (e, t, n) {
    ...
    f = function (e, t, n) {
      ...
      if ("IMG" === o) {
        ...
        var s = d(e, t);
        return (
          s && e.setAttribute("srcset", s), void (i && e.setAttribute("src", i))
        );
      }
      "IFRAME" !== o
  ...
  v.prototype = {
    _reveal: function (e) {
      ...
      n(t.callback_enter, e),
        ("IMG" !== e.tagName && "IFRAME" !== e.tagName) ||
          (e.addEventListener("load", i),
          e.addEventListener("error", o),
          m(e, t.class_loading)),
        f(e, t.data_srcset, t.data_src),
        n(t.callback_set, e);
    },
    _loopThroughElements: function () {
      ...
      for (s = 0; s < i; s++) {
        var a = o[s];
        (e.skip_invisible && null === a.offsetParent) ||
          ((t || c(a, e.container, e.threshold)) &&
            (l && m(a, e.class_initial),
            this._reveal(a),
            r.push(s),
            h(a, "was-processed", !0)));
      }
  ...
  return (
    w &&
      (function (e, t) {
        var n = t.length;
        if (n) for (var o = 0; o < n; o++) u(e, t[o]);
        else u(e, t);
      })(v, w),
    v
  );
...
(function (factory) {
  ...
  function init(converter) {
    ...
    api.getJSON = function () {
      return api.apply({ json: !0 }, arguments);
    };
...
jQuery(document).ready(function ($) {
  var $body = $("body"),
    $html = $("html");
  var $cookieWarning = $(".layout-cookie-warning");
  if ($cookieWarning.length) {
    if (!Cookies.get("addedlovely_cookie_warning")) {
      $cookieWarning.addClass("active");
      $cookieWarning.find("button").on("click", function (e) {
        e.preventDefault();
        Cookies.set("addedlovely_cookie_warning", !0, { expires: 365 });
  ...
  $body.on(
    "click",
    "div[data-toggle], button[data-toggle], a[data-toggle]",
    function (e) {
      e.preventDefault();
      $body.toggleClass($(this).data("toggle"));
    }
  );
  $body.on("click", "button[data-scroll]", function (e) {
    e.preventDefault();
    $("html, body").animate(
  ...
  function popUp($target, width, height) {
    ...
    window.open(
      ...
      "width=" +
        ...
        ",height=" +
        height +
        ",toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0"
    );
  }
});
(function (d) {
...
jQuery(document).ready(function ($) {
  ...
  function setupSlideshow() {
    if ($(".gallery-introduction-slideshow").length > 0) {
      $(".gallery-introduction-slideshow .image").shuffle();
      $(".gallery-introduction-slideshow .image")
        .first()
        .addClass("active")
        .on("click", function (e) {
  ...
  function setupGallery() {
    if ($(".layout-gallery-slideshow").length) {
      var $caption = $(".gallery-caption");
      var $slides = $(".layout-gallery-slideshow .slide");
      $(".layout-gallery-slideshow").on("init", function () {
        lazyLoadImages.update();
      });
      var $gallery = $(".layout-gallery-slideshow")
        .slick({
          autoplay: !1,
          arrows: !0,
          dots: !1,
        ...
        .on("beforeChange", function (event, slick, currentSlide, nextSlide) {
          lazyLoadImages.update();
          $caption.text($slides.eq(nextSlide).data("caption"));
          if ($slides.eq(nextSlide).hasClass("is-fullscreen")) {
      ...
      if (
        $(".layout-gallery-slideshow .slide:first").hasClass("is-fullscreen")
      ) {
        $body.addClass("is-fullscreen");
      }
  ...
  function setupLightbox() {
    var lightbox = $("[data-fancybox]").fancybox({
      margin: [98, 30],
      gutter: 30,
      infobar: !1,
      toolbar: !0,
      ...
      btnTpl: {
        close:
          '<button data-fancybox-close class="lightbox-button lightbox-close" title="{{CLOSE}}">Close</button>',
        arrowLeft:
          '<button data-fancybox-prev data-direction="left" class="lightbox-button lightbox-left"><span>Previous</span></button>',
        arrowRight:
          '<button data-fancybox-next data-direction="right" class="lightbox-button lightbox-right"><span>Next</span></button>',
      },
      baseTpl:
        '<div class="fancybox-container" role="dialog" tabindex="-1">' +
        '<div class="fancybox-bg"><h1 class="logo"><a href="/">Nikolai von Bismarck</a></h1></div>' +
  ...
  function setupCursor() {
    ...
    if (!Modernizr.touchevents) {
      $("body")
        .on("mousemove", ".lightbox-left, .lightbox-right", function (e) {
          $cursor.css({ top: e.clientY, left: e.clientX });
        })
        .on("mouseenter", ".lightbox-left, .lightbox-right", function () {
          $cursor.addClass("active " + $(this).data("direction"));
        })
        .on("mouseleave", ".lightbox-left, .lightbox-right", function () {
          $cursor.removeClass("active " + $(this).data("direction"));
        });
    }
  }
  function correctGalleryMargin($target) {
    defaultMargin = 500;
    height = $target.height();
    parent = $target.parent().parent().outerHeight();
    if (height < parent) {
      offset = defaultMargin - (parent - height) / 2;
      $target.parent().parent().css("margin-bottom", offset);
    }
  }
  function setupGalleryMargins() {
    var $image = $(
        $(".columns-3 .layout-image, .columns-2 .layout-image").get().reverse()
      ),
      width = $(window).width();
    $image.each(function (e) {
      if (width <= 768) {
        $(this).parent().css({ "margin-bottom": 0, "margin-top": 0 });
      } else {
        ratio = $(this).width() / $(this).find("a").data("width");
        rowHeight = $(this).outerHeight();
        imageHeight = $(this).find("a").data("height") * ratio;
        if (rowHeight > imageHeight) {
          offset = -1 * ((rowHeight - imageHeight) / 2);
          $(this)
            .parent()
            .css({ "margin-bottom": offset, "margin-top": offset });
        }
      }
    });
  }
